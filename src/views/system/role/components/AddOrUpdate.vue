<template>
	<el-dialog v-model="visible" :title="form.id ? '编辑' : '添加'" width="550px" @closed="onReset" append-to-body>
		<el-form :model="form" label-width="55px" ref="formRef">
			...
			<el-form-item label="标识" prop="role_name">
				<el-input v-model="form.role_name" placeholder="请输入标识" clearable></el-input>
			</el-form-item>
		</el-form>
		<template #footer>
